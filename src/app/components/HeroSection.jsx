    ...
    return (
        <div>
                ...
                <div className="max-w-screen-xl mx-auto text-center text-white relative px-6 md:px-8 lg:px-12 py-1">
                    ...
                    >
                        ...
                        <div className="space-x-2 sm:space-x-8 pt-10">
                            <a
                                href="#about"
                                className={`${isReadMoreActive ? 'bg-blue-500' : 'bg-gray-500'
                                    } hover:${isReadMoreActive ? 'bg-color-500' : 'bg-color-500'} text-white px-5 py-2 border border-black font-semibold`}
                            ...
                            <a
                                href="/aboutus"
                                className={`${!isReadMoreActive ? 'bg-blue-500' : 'bg-gray-500'
                                    } hover:${!isReadMoreActive ? 'bg-color-500' : 'bg-color-500'} text-white px-5 py-2 border border-white font-semibold`}
            ...
            <motion.div
                ...
                variants={containerVarients}
            >
                <div className="bg-blue-500 text-white font-semibold px-6 py-4 text-lg w-80 text-center shadow-lg">
