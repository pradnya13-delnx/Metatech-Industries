                ...
                <div className="flex justify-end items-center p-2">
                    <nav>
                        <ul className="flex flex-row items-center space-x-1 py-1">
                            <li>
                                <a href="/#" className="hover:text-blue-400 text-base font-semibold hover:bg-slate-100 py-3 px-2">
                                    Home
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="/aboutus" className="hover:text-blue-400 text-base font-semibold hover:bg-slate-100 py-3 px-2">
                                    About
                                </a>
                            </li>
                            <li>
